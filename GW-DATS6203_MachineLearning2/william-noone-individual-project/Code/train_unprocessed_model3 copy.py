...
os.chdir(my_root)
plot_path = 'figures_unprocessed_model3/'
...
solver = caffe.SGDSolver('Unprocessed_Model3_solver.prototxt')
...
f1_0 = net.blobs['conv1'].data[0, :32]
plt.figure(3)
vis_square_f(f1_0)
#plt.xlabel('x')
#plt.ylabel('x')
...
f1_0 = net.blobs['pool1'].data[0, :32]
plt.figure(3)
vis_square_f(f1_0)
#plt.xlabel('x')
#plt.ylabel('x')
...
f1_0 = net.blobs['conv2'].data[0, :32]
plt.figure(3)
vis_square_f(f1_0)
#plt.xlabel('x')
#plt.ylabel('x')
...
f1_0 = net.blobs['pool2'].data[0, :32]
plt.figure(3)
vis_square_f(f1_0)
#plt.xlabel('x')
#plt.ylabel('x')
...
#%% Plot All Feature maps Conv3

net = solver.net

f1_0 = net.blobs['conv3'].data[0, :64]
plt.figure(3)
vis_square_f(f1_0)
#plt.xlabel('x')
#plt.ylabel('x')
...
#%% Plot All Feature maps Pool3

net = solver.net

f1_0 = net.blobs['Pool3'].data[0, :64]
plt.figure(3)
vis_square_f(f1_0)
#plt.xlabel('x')
#plt.ylabel('x')
plt.title('Feature Maps for Pool3')
#plt.text(60, .025, r'$\mu=100,\ \sigma=15$')
#plt.axis([40, 160, 0, 0.03])
#plt.grid(True)
...
plt.savefig(plot_path + 'figure_9.png')
...
plt.savefig(plot_path + 'figure_10.png')
...
plt.savefig(plot_path + 'figure_11.png')
