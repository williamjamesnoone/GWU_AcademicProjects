...
train_lmdb = 'lmdb_dir/unprocessed_lmdb/train_lmdb/'
validation_lmdb = 'lmdb_dir/unprocessed_lmdb/validation_lmdb/'

# Put training jpg images path here
JPG_train_path = 'malaria_data/Unprocessed_Directory/train/'

# Put validation jpg images path here
JPG_validation_path = 'malaria_data/Unprocessed_Directory/validation/'
